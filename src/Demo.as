package
{
    ...
    public class Demo extends Sprite
    {
        ...
        public function Demo()
        {
			...
			mParticleSystem.addEventListener(TouchEvent.TOUCH, onParticleClick);
		...
		private function onParticleClick (e: TouchEvent)
		{
			//(e.currentTarget as DisplayObject).width -= 10;
			//(e.currentTarget as DisplayObject).height -= 10;
			//trace ((e.currentTarget as DisplayObject).width.toString() + " " + (e.currentTarget as DisplayObject).height.toString());
		}
