package Beasts 
{
	 ...
	 * @author injer
	 */
	public class FireLizard extends Cell
	{
		...
		public function FireLizard(rad: int) 
		{
			this.width = rad * 2;
			this.height = rad * 2;
			...
			addChild(mainClip);
			var text: TextField = new TextField(rad*2, rad*2, "FireLizard","Verdana",12,Color.argb(100,0,255,0));
			text.x = -rad;
			text.y = -rad;
			addChild(text);
			type = "FireLizard";
