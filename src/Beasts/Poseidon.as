package Beasts 
{
	 ...
	 * @author injer
	 */
	public class Poseidon extends Cell
	{
		...
		public function Poseidon(rad: int) 
		{
			this.width = rad * 2;
			this.height = rad * 2;
			...
			addChild(mainClip);
			var text: TextField = new TextField(rad*2, rad*2, "Poseidon","Verdana",12,Color.argb(100,0,255,0));
			text.x = -rad;
			text.y = -rad;
			addChild(text);
			type = "Poseidon";
