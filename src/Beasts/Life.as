package Beasts 
{
	...
	{
		[Embed(source = "/../res/beasts/Life/Life.png")]
		const TestBall: Class;
		[Embed(source="/../res/beasts/Life/Life.xml", mimeType="application/octet-stream")]
		const TestBallXML:Class;
		
		public function Life(rad: int) 
		{
			this.width = rad * 2;
			this.height = rad * 2;
			...
			addChild(mainClip);
			var text: TextField = new TextField(rad*2, rad*2, "Life","Verdana",12,Color.argb(100,0,255,0));
			text.x = -rad;
			text.y = -rad;
			addChild(text);
			type = "Life";
