package Beasts 
{
	 ...
	 * @author injer
	 */
	public class Brain extends Cell
	{
		[Embed(source = "/../res/beasts/Brain/Brain.png")]
		const TestBall: Class;
		[Embed(source="/../res/beasts/Brain/Brain.xml", mimeType="application/octet-stream")]
		const TestBallXML:Class;
		
		public function Brain(rad: int) 
		{
			this.width = rad * 2;
			this.height = rad * 2;
			...
			addChild(mainClip);
			var text: TextField = new TextField(rad*2, rad*2, "Brain","Verdana",12,Color.argb(100,0,255,0));
			text.x = -rad;
			text.y = -rad;
			addChild(text);
			type = "Brain";
