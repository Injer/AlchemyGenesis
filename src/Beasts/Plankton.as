package Beasts 
{
	 ...
	 * @author injer
	 */
	public class Plankton extends Cell
	{
		[Embed(source = "/../res/beasts/Plankton/Plankton.png")]
		const TestBall: Class;
		[Embed(source="/../res/beasts/Plankton/Plankton.xml", mimeType="application/octet-stream")]
		const TestBallXML:Class;
		
		public function Plankton(rad: int) 
		{
			this.width = rad * 2;
			this.height = rad * 2;
			...
			addChild(mainClip);
			var text: TextField = new TextField(rad*2, rad*2, "Plankton","Verdana",12,Color.argb(100,0,255,0));
			text.x = -rad;
			text.y = -rad;
			addChild(text);
			type = "Plankton";
