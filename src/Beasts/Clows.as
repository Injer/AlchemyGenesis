package Beasts 
{
	 ...
	 * @author injer
	 */
	public class Clows extends Cell
	{
		[Embed(source = "/../res/beasts/Clows/Clows.png")]
		const TestBall: Class;
		[Embed(source="/../res/beasts/Clows/Clows.xml", mimeType="application/octet-stream")]
		const TestBallXML:Class;
		
		public function Clows(rad: int) 
		{
			this.width = rad * 2;
			this.height = rad * 2;
			...
			addChild(mainClip);
			var text: TextField = new TextField(rad*2, rad*2, "Clows","Verdana",12,Color.argb(100,0,255,0));
			text.x = -rad;
			text.y = -rad;
			addChild(text);
			type = "Clows";
