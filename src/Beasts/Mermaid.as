package Beasts 
{
	 ...
	 * @author injer
	 */
	public class Mermaid extends Cell
	{
		...
		public function Mermaid(rad: int) 
		{
			this.width = rad * 2;
			this.height = rad * 2;
			...
			addChild(mainClip);
			var text: TextField = new TextField(rad*2, rad*2, "Mermaid","Verdana",12,Color.argb(100,0,255,0));
			text.x = -rad;
			text.y = -rad;
			addChild(text);
			type = "Mermaid";
