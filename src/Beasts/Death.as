package Beasts 
{
	...
	{
		[Embed(source = "/../res/beasts/Death/Death.png")]
		const TestBall: Class;
		[Embed(source="/../res/beasts/Death/Death.xml", mimeType="application/octet-stream")]
		const TestBallXML:Class;
		
		public function Death(rad: int) 
		{
			this.width = rad * 2;
			this.height = rad * 2;
			...
			addChild(mainClip);
			var text: TextField = new TextField(rad*2, rad*2, "Death","Verdana",12,Color.argb(100,0,255,0));
			text.x = -rad;
			text.y = -rad;
			addChild(text);
			type = "Death";
