package Beasts 
{
	 ...
	 * @author injer
	 */
	public class Chitin extends Cell
	{
		[Embed(source = "/../res/beasts/Chitin/Chitin.png")]
		const TestBall: Class;
		[Embed(source="/../res/beasts/Chitin/Chitin.xml", mimeType="application/octet-stream")]
		const TestBallXML:Class;
		
		public function Chitin(rad: int) 
		{
			this.width = rad * 2;
			this.height = rad * 2;
			...
			addChild(mainClip);
			var text: TextField = new TextField(rad*2, rad*2, "Chitin","Verdana",12,Color.argb(100,0,255,0));
			text.x = -rad;
			text.y = -rad;
			addChild(text);
			type = "Chitin";
