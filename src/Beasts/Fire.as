package Beasts 
{
	...
	{
		[Embed(source = "/../res/beasts/Fire/Fire.png")]
		const TestBall: Class;
		[Embed(source="/../res/beasts/Fire/Fire.xml", mimeType="application/octet-stream")]
		const TestBallXML:Class;
		
		public function Fire(rad: int) 
		{
			this.width = rad * 2;
			this.height = rad * 2;
			...
			addChild(mainClip);
			var text: TextField = new TextField(rad*2, rad*2, "Fire","Verdana",12,Color.argb(100,0,255,0));
			text.x = -rad;
			text.y = -rad;
			addChild(text);
			type = "Fire";
