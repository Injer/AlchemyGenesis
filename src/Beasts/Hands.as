package Beasts 
{
	 ...
	 * @author injer
	 */
	public class Hands extends Cell
	{
		[Embed(source = "/../res/beasts/Hands/Hands.png")]
		const TestBall: Class;
		[Embed(source="/../res/beasts/Hands/Hands.xml", mimeType="application/octet-stream")]
		const TestBallXML:Class;
		
		public function Hands(rad: int) 
		{
			this.width = rad * 2;
			this.height = rad * 2;
			...
			addChild(mainClip);
			var text: TextField = new TextField(rad*2, rad*2, "Hands","Verdana",12,Color.argb(100,0,255,0));
			text.x = -rad;
			text.y = -rad;
			addChild(text);
			type = "Hands";
