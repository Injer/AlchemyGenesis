package Beasts 
{
	...
	{
		[Embed(source = "/../res/beasts/Tail/Tail.png")]
		const TestBall: Class;
		[Embed(source="/../res/beasts/Tail/Tail.xml", mimeType="application/octet-stream")]
		const TestBallXML:Class;
		
		public function Tail(rad: int) 
		{
			this.width = rad * 2;
			this.height = rad * 2;
			...
			addChild(mainClip);
			var text: TextField = new TextField(rad*2, rad*2, "Tail","Verdana",12,Color.argb(100,0,255,0));
			text.x = -rad;
			text.y = -rad;
			addChild(text);
			type = "Tail";
